/*
 * This is done to avoid just putting the text into a < p > tag making it harder to edit.
 * However I imagine at some point we'd want a better solution such as loading from markdown.
 */
